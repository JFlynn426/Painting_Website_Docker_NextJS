...
public class PaintingWriteModelConfiguration : IEntityTypeConfiguration<PaintingWriteModel>
{
    public void Configure(EntityTypeBuilder<PaintingWriteModel> builder)
    {
