...
public static class PaintingsSeedData
{
    public static readonly List<PaintingSeed> Paintings = new()
    {
        ...
        new PaintingSeed { Title = "Rainbow River", Slug = "rainbow-river", Description = "A vibrant river scene with colorful reflections.", ImageUrl = "/Landscapes and Cityscapes/Rainbow River1.jpg", CategorySlug = "landscapes-and-cityscapes", Width = 24, Height = 32, Year = 2022, Price = 1250, IsAvailable = true },
