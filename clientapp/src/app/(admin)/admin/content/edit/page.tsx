...
export default async function EditContentPage() {
    ...
    return (
        <div>
            <h1 className="text-3xl font-bold mb-6 text-[var(--title-color)]">Edit Existing Page Content</h1>
                ...
                <div className="space-y-4">
                    {pageContents.map((content) => (
                        <div key={content.id} className="bg-[var(--navbar-footer-bg)] rounded-lg p-6 flex justify-between items-center">
                            <div>
                                <h2 className="text-xl font-bold text-[var(--title-color)]">{content.title || content.slug}</h2>
